...
export default function Footer() {
  return (
    <footer className="bg-primary text-text-light/70">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-accent font-heading font-semibold mb-6 text-lg">Quick Links</h4>
            <ul className="space-y-3">
              {[
                ...
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-sm hover:text-accent transition-colors duration-300 flex items-center gap-2"
                  >
          ...
          {/* Services */}
          <div>
            <h4 className="text-accent font-heading font-semibold mb-6 text-lg">Services</h4>
            <ul className="space-y-3">
              {[
                "Room Consultation",
                "Full Room Design",
          ...
          {/* Contact */}
          <div>
            <h4 className="text-accent font-heading font-semibold mb-6 text-lg">Get In Touch</h4>
